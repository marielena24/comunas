...
include('../conexion/cone.php');
  ...
  $sql = "SELECT * FROM jefe_de_familia WHERE id = '".$id."'";
  ...
  $row = mysqli_fetch_assoc($result);
   ...
   if(isset($boton))
   {
     ...
     $sql = "UPDATE jefe_de_familia SET nombre='$nombre', apellido = '$apellido', ci = '$cedula', tlf = '$tlf', edad='$edad', cne = '$cne', sexo = '$sexo', direccion= '$direccion', embarazada = '$embarazada', instrucción = '$instrucción', profesion = '$profesion', parentesco = '$parentesco' WHERE id = $id";
      $result = $conexion->query($sql);
...
<link rel="stylesheet" href="css/estilos.css">
 ...
 <div class="contenedor">
    <h3 align="center">Actualizar Jefe de Familia</h3>
